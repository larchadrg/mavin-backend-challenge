...
from llms_used import MODEL_FOR_EMBEDDING, MODEL_FOR_RESPONSE
...
def select_context_text(docs, query) -> list[Document]: 
...
def generate_response(query: str) -> ResponseModel:
    ...
    context_text ="\n".join([doc.page_content for doc in context_texts_list])
    ...
    return {
        ...
        "sources": {
            "urls": urls, 
            "content_used_as_context": [doc.page_content for doc in context_texts_list] 
        }, 
